-- ============================================
-- FIX 053: riders.dnf kolom voor directe DNF-markering door admin
-- Admin kan renner als DNF markeren zonder etapperesultaat op te zoeken.
-- submit_pick checkt ook deze kolom.
-- ============================================

ALTER TABLE riders ADD COLUMN IF NOT EXISTS dnf boolean NOT NULL DEFAULT false;

-- submit_pick: ook riders.dnf checken
...
BEGIN
  ...
  -- Check 2: renner heeft DNF (via stage_results of riders.dnf vlag)
  SELECT EXISTS(
...
-- assign_random_riders: ook riders.dnf uitsluiten
