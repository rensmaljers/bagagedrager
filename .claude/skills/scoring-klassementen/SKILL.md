...
De views worden telkens in één migratie volledig opnieuw gedefinieerd (`DROP VIEW` + `CREATE VIEW`). De laatste volledige definitie is leidend — zoek de hoogst genummerde migratie die `CREATE VIEW general_classification` bevat:
